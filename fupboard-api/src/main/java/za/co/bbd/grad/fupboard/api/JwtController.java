...
public class JwtController {
	...
	public Map<String, Object> get_claims(@AuthenticationPrincipal Jwt jwt) {
	...
	public String post_jwt(JwtRequest req) throws URISyntaxException, IOException, InterruptedException {
